...
Or, preferably pick what you want separatey.
...
** =popup-kill-ring==
Browse through your kill-ring with M-y instead of merely "cycling" through it. Useful when yanking and pasting, for example.
#+begin_src emacs-lisp
