...
* =Org= mode
You might've heard of people that use Emacs just because of [[https://orgmode.org/][=Org=]] mode. Folks use it for a myiriad of reasons; from simple note-taking to literate programming and computational notebooks.
